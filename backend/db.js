...
export const categories = ['Горячие блюда', 'Плов', 'Бургеры', 'Тайская кухня', 'Салаты', 'Закуски к пиву', 'Разливное пиво', 'Бутылочное пиво', 'Вино', 'Крепкий алкоголь', 'Безалкогольные'];
export const categoryGroups = {
  food: ['Горячие блюда', 'Плов', 'Бургеры', 'Тайская кухня', 'Салаты', 'Закуски к пиву'],
...
export const menu = [
  // ----- ЕДА · Шашлык и гриль -----
  // Вес, цены и составы — по карточкам кухни (2026-08-28). Составы дословно.
  m('Шашлык из свинины', 'Горячие блюда', 250, 'Сочный и нежный свиной шашлык, идеально приготовленный на гриле.', {
    nameEn: 'Pork Shashlik', weight: '250 г', composition: 'мясо свинины, маринованный лук, фирменный соус пряно-томатный GROT', calories: 540, popular: true, image: '/menu/pork-skewer.jpg',
  ...
  m('Шашлык из утки', 'Горячие блюда', 300, 'Премиальная утка с хрустящей корочкой и насыщенным вкусом.', {
    nameEn: 'Duck Shashlik', weight: '200 г', composition: 'грудка утки, маринованный лук, горчичный соус', calories: 560, popular: true, image: '/menu/duck-skewer.jpg',
    recipe: { [ING.duck]: 250, [ING.onion]: 30 } }),
  m('Куриные крылышки на углях', 'Горячие блюда', 250, 'Сочные куриные крылышки, приготовленные на углях до идеальной корочки.', {
    nameEn: 'Charcoal-Grilled Chicken Wings', weight: '6 шт.', composition: 'крылья курицы, маринованный лук, фирменный соус пряно-томатный GROT', calories: 620, popular: true, image: '/menu/chicken-wings.jpg',
    recipe: { [ING.chicken_wings]: 360 } }),
  m('Шашлык из куриного филе', 'Горячие блюда', 250, '', {
    nameEn: 'Chicken Fillet Shashlik', weight: '250 г', composition: 'куриное филе, маринованный лук, фирменный соус пряно-томатный GROT', image: null }),
  m('Шашлык из куриных крыльев', 'Горячие блюда', 300, '', {
    nameEn: 'Chicken Wing Shashlik', weight: '300 г', composition: 'цельное куриное крыло, маринованный лук, фирменный соус пряно-томатный GROT', image: null }),
  m('Свиные рёбрышки в пивном маринаде', 'Горячие блюда', 250, '', {
    nameEn: 'Pork Ribs in Beer Marinade', weight: '250 г', composition: 'рёбра свиные, маринованный лук, горчичный соус', image: null }),
  m('Шашлык из свинины на кости', 'Горячие блюда', 250, '', {
    nameEn: 'Bone-In Pork Shashlik', weight: '250 г', composition: 'мясо свинины на ребре, маринованный лук, горчичный соус', image: null }),
  m('Шашлык из баранины', 'Горячие блюда', 450, '', {
    nameEn: 'Lamb Shashlik', weight: '200 г', composition: 'мясо баранины, маринованный лук, фирменный соус пряно-томатный GROT', image: null }),
  ...
  m('Купаты свиные', 'Горячие блюда', 250, '', {
    nameEn: 'Pork Kupaty Sausages', weight: '200 г', composition: 'мясо свинины, свиной шпик, черева, салат из овощей, mini waffle hashbrown, маринованный лук, горчичный соус', image: null }),
  m('Купаты из курицы и свинины', 'Горячие блюда', 250, '', {
    nameEn: 'Chicken and Pork Kupaty Sausages', weight: '200 г', composition: 'мясо свинины, мясо курицы, черева, салат из овощей, mini waffle hashbrown, маринованный лук, горчичный соус', image: null }),

  // ----- ЕДА · Плов -----
  // Свой раздел: в списке кухни плов вынесен отдельно от горячих блюд.
  m('Плов из австралийской говядины', 'Плов', 350, '', {
    nameEn: 'Australian Beef Pilaf', weight: '400 г', composition: 'рис басмати, мясо говядины, морковь, чеснок, перец стручковый, салат ачик-чучук', image: null }),
  m('Плов из новозеландской баранины', 'Плов', 350, '', {
    nameEn: 'New Zealand Lamb Pilaf', weight: '400 г', composition: 'рис басмати, мясо баранины, морковь, чеснок, перец стручковый, салат ачик-чучук', image: null }),

  // ----- ЕДА · Бургеры -----
  // Названия — как в печатной карте и в списке кухни, по-английски (как у пива
  // и вина), поэтому name и nameEn совпадают. Все на булочке бриошь
  // с фирменным соусом: говяжьи по 300 бат, куриные по 250.
  m('Beef Smash Burger', 'Бургеры', 300, 'Фирменный рецепт нашего шеф-повара: две говяжьи котлеты smash, расплавленный чеддер, фирменный соус, мягкая булочка бриошь.', {
    nameEn: 'Beef Smash Burger', weight: '300 г', composition: 'булочка бриошь, две smash котлеты из говядины, сыр чеддер, маринованные огурцы, свежий красный лук, чипсы, фирменный соус', calories: 920, popular: true, image: '/menu/smash-burger.jpg',
    recipe: { [ING.beef]: 180, [ING.bun]: 1, [ING.cheddar]: 40, [ING.red_onion]: 15 } }),
  m('Beef Smash Burger with Bacon', 'Бургеры', 300, '', {
    nameEn: 'Beef Smash Burger with Bacon', weight: '300 г', composition: 'булочка бриошь, две smash котлеты из говядины, сыр чеддер, копчёный бекон, маринованные огурцы, красный лук, фирменный соус', image: null }),
  m('Beef Smash Burger with Jalapeño', 'Бургеры', 300, '', {
    nameEn: 'Beef Smash Burger with Jalapeño', weight: '300 г', composition: 'булочка бриошь, две smash котлеты из говядины, сыр чеддер, халапеньо, фирменный соус', image: null }),
  m('Beef Mushroom Burger', 'Бургеры', 300, '', {
    nameEn: 'Beef Mushroom Burger', weight: '300 г', composition: 'булочка бриошь, две smash котлеты из говядины, сыр чеддер, творожный сыр, шампиньоны, фирменный соус', image: null }),
  m('Beef Burger', 'Бургеры', 300, '', {
    nameEn: 'Beef Burger', weight: '300 г', composition: 'булочка бриошь, котлета из говядины, помидор, карамелизированный лук, копчёный бекон, салат айсберг, фирменный соус', image: null }),
  m('Beef Cheeseburger', 'Бургеры', 300, '', {
    nameEn: 'Beef Cheeseburger', weight: '300 г', composition: 'булочка бриошь, котлета из говядины, сыр чеддер, помидор, маринованный огурец, салат айсберг, фирменный соус', image: null }),
  m('Pulled Pork Burger', 'Бургеры', 300, '', {
    nameEn: 'Pulled Pork Burger', weight: '300 г', composition: 'булочка бриошь, рваная свинина, сыр чеддер, сыр пармезан, маринованный огурец, фирменный соус', image: null }),
  m('Chicken Mushroom Burger', 'Бургеры', 250, '', {
    nameEn: 'Chicken Mushroom Burger', weight: '270 г', composition: 'булочка бриошь, мясо курицы, сыр чеддер, творожный сыр, шампиньоны, красный лук, салат айсберг, фирменный соус', image: null }),
  m('Chicken Burger with Jalapeño', 'Бургеры', 250, '', {
    nameEn: 'Chicken Burger with Jalapeño', weight: '270 г', composition: 'булочка бриошь, мясо курицы, сыр чеддер, маринованный огурец, салат айсберг, халапеньо, фирменный соус', image: null }),
  m('Chicken Cheese Burger', 'Бургеры', 250, '', {
    nameEn: 'Chicken Cheese Burger', weight: '270 г', composition: 'булочка бриошь, мясо курицы, сыр чеддер, сыр моцарелла, салат айсберг, маринованный огурец, фирменный соус', image: null }),
  ...
  // Карточка повара (Александр, WhatsApp), 2026-09-16.
  m('Кау Пад Тай — жареный рис с курицей', 'Тайская кухня', 150, '', {
    nameEn: 'Khao Pad Thai — Fried Rice with Chicken', weight: '300 г', composition: 'рис, курица, кукуруза, зелёный горошек, морковь, яйцо, чеснок, лук, лайм', image: null }),
  ...
  m('Перша Гільдія (шот 30 мл)', 'Крепкий алкоголь', 160, 'Украинская водка.', { group: 'drinks', nameEn: 'Persha Hildiia (shot 30 ml)', weight: '30 мл', image: null }),
  m('Перша Гільдія (бутылка 0.7 л)', 'Крепкий алкоголь', 2600, 'Украинская водка.', { group: 'drinks', nameEn: 'Persha Hildiia (bottle 0.7 L)', weight: '0.7 л', image: null }),
...
const MENU_RENAME_TO = {
  ...
  'Куриные крылышки (6 шт.)': 'Куриные крылышки на углях',
  'Куриные крылышки': 'Куриные крылышки на углях',
  ...
  // Список кухни от 2026-08-28: названия уточнены.
  'Шашлык из баранины (мякоть)': 'Шашлык из баранины',
  'Шашлык из куриного крыла': 'Шашлык из куриных крыльев',
  // Бургеры вынесены в собственный раздел и названы по-английски, как в карте.
  // Пара записей на позицию: сработает та, чьё имя найдётся в базе.
  'Smash Burger': 'Beef Smash Burger',
  'Бургер Smash с говядиной': 'Beef Smash Burger',
  'Бургер Smash с говядиной и беконом': 'Beef Smash Burger with Bacon',
  'Бургер Smash с говядиной и халапеньо': 'Beef Smash Burger with Jalapeño',
  'Бургер с говядиной и грибами': 'Beef Mushroom Burger',
  'Бургер с говядиной': 'Beef Burger',
  'Чизбургер с говядиной': 'Beef Cheeseburger',
  'Бургер с курицей и грибами': 'Chicken Mushroom Burger',
  'Бургер с курицей и халапеньо': 'Chicken Burger with Jalapeño',
  'Чизбургер с курицей': 'Chicken Cheese Burger',
  // Кухня подтвердила: единственный свиной бургер — Pulled Pork Burger.
  'Бургер со свининой': 'Pulled Pork Burger',
  'Бургер с томлёной свининой': 'Pulled Pork Burger',
  // Бренд пишется кириллицей.
  'Persha Hildiia (шот 30 мл)': 'Перша Гільдія (шот 30 мл)',
  'Persha Hildiia (бутылка 0.7 л)': 'Перша Гільдія (бутылка 0.7 л)',
...
const MENU_PRICES = {
  ...
  // Список кухни от 2026-08-28
  'Плов из австралийской говядины': 350,                   // было 300
};
