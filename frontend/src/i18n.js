// Подпись категории меню с переводом. Категории приходят из БД на русском,
// поэтому переводим по ключу «cat_<название>»; если перевода нет — показываем
// само название (а не ключ). Используется и в меню клиента, и в заказе официанта.
export const catLabel = (t, c) => {
  if (c === 'all' || c === 'Все') return t('all');
...
export const STR = {
  ru: {
    ...
    subtotal: 'Подытог', discount: 'Скидка', discount_food: 'Скидка на еду', discount_drinks: 'Скидка на напитки',
    kitchen_closed_banner: 'Кухня закрыта — доступны только напитки', kitchen_closed_item: 'кухня закрыта',
    prebill: 'Пре-чек (до оплаты)',
    split: 'Разделить', split_title: 'Разделить счёт', split_even: 'Поровну', split_items: 'По позициям',
    split_guests: 'Гостей', split_assign_hint: 'Нажмите, чтобы назначить позицию гостю',
    split_shared: 'Общее', guest: 'Гость', split_pay: 'Оплатить', split_finish: 'Закрыть счёт',
    shift_drawer_hint: 'Разменный фонд + оплаты наличными (карты в кассе нет)',
    reprint: 'Перепечатать', reprint_title: 'Перепечать чека', reprint_hint: 'Оплаченные счета за сегодня — нажмите, чтобы перепечатать', no_recent_bills: 'Сегодня ещё не было оплат',
    ...
    // категории меню
    'cat_Горячие блюда': 'Горячие блюда', 'cat_Плов': 'Плов', 'cat_Бургеры': 'Бургеры', 'cat_Салаты': 'Салаты', 'cat_Тайская кухня': 'Тайская кухня', 'cat_Закуски к пиву': 'Закуски к пиву',
  ...
  en: {
    ...
    subtotal: 'Subtotal', discount: 'Discount', discount_food: 'Food discount', discount_drinks: 'Drinks discount',
    kitchen_closed_banner: 'Kitchen is closed — drinks only', kitchen_closed_item: 'kitchen closed',
    prebill: 'Pre-bill (before payment)',
    split: 'Split', split_title: 'Split bill', split_even: 'Evenly', split_items: 'By items',
    split_guests: 'Guests', split_assign_hint: 'Tap to assign an item to a guest',
    split_shared: 'Shared', guest: 'Guest', split_pay: 'Pay', split_finish: 'Close bill',
    shift_drawer_hint: 'Cash float + cash payments (card is not in the drawer)',
    reprint: 'Reprint', reprint_title: 'Reprint a bill', reprint_hint: "Today's paid bills — tap to reprint", no_recent_bills: 'No payments yet today',
    ...
    'cat_Горячие блюда': 'Hot Dishes', 'cat_Плов': 'Pilaf', 'cat_Бургеры': 'Burgers', 'cat_Салаты': 'Salads', 'cat_Тайская кухня': 'Thai Cuisine', 'cat_Закуски к пиву': 'Beer Snacks',
