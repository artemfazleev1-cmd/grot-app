...
export const STR = {
  ru: {
    ...
    // категории меню
    'cat_Горячие блюда': 'Горячие блюда', 'cat_Салаты': 'Салаты', 'cat_Тайская кухня': 'Тайская кухня', 'cat_Закуски к пиву': 'Закуски к пиву',
  ...
  en: {
    ...
    'cat_Горячие блюда': 'Hot Dishes', 'cat_Салаты': 'Salads', 'cat_Тайская кухня': 'Thai Cuisine', 'cat_Закуски к пиву': 'Beer Snacks',
