...
export const STR = {
  ru: {
    ...
    need_location_for_delivery: 'Доставка — в радиусе 8 км от бара. Укажите адрес или определите местоположение.',
  ...
  en: {
    ...
    need_location_for_delivery: 'Delivery is within 8 km of the bar. Enter an address or detect your location.',
